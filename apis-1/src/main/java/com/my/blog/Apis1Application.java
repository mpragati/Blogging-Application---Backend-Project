...
public class Apis1Application implements CommandLineRunner {
	...
	public static void main(String[] args) {
		SpringApplication.run(Apis1Application.class, args);
	...
	public void run(String... args) throws Exception {
      ...
      System.out.println(this.passwordEncoder.encode("jrabcd"));	
